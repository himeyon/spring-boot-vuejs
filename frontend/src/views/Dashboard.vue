...
export default {
  ...
  data: function () {
    return {
      ...
      tableItems: [
        {
          avatar: { url: require('./../assets/img/avatars/1.jpg'), status: 'success' },
        ...
        {
          avatar: { url: require('./../assets/img/avatars/2.jpg'), status: 'danger' },
        ...
        {
          avatar: { url: require('./../assets/img/avatars/3.jpg'), status: 'warning' },
        ...
        {
          avatar: { url: require('./../assets/img/avatars/4.jpg'), status: '' },
        ...
        {
          avatar: { url: require('./../assets/img/avatars/5.jpg'), status: 'success' },
        ...
        {
          avatar: { url: require('./../assets/img/avatars/6.jpg'), status: 'danger' },
